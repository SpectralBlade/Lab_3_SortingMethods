...
class TestSortingAlgorithms:
    ...
    def test_basic_cases(self, sorting_algorithm, test_case: list[int]):
    ...
    def test_nearly_sorted_arrays(self, sorting_algorithm):
        test_cases = [
    ...
    def test_arrays_with_duplicates(self, sorting_algorithm):
        test_cases = [
...
class TestBucketSort:
    def test_bucket_sort_basic(self, float_sorting_algorithm):
        test_cases = [
    ...
    def test_float_arrays(self, float_sorting_algorithm):
        test_cases = [
...
class TestValueErrorsInSorts:
    def test_value_errors(self, sorting_algorithm):
        with pytest.raises(ValueError):
...
class TestSortingWithKeyAndCmp:
    ...
    def test_sort_with_random_keys(self, sorting_algorithm):
        for _ in range(10):
    ...
    @pytest.mark.parametrize("sorting_algorithm", [bubble_sort, quick_sort, heap_sort])
    def test_sort_with_random_cmp(self, sorting_algorithm):
        for _ in range(10):
            arr, key, cmp_fn = generate_test_with_key_cmp(
