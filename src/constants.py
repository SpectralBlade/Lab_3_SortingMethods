...
fact_recursive X       - вычислить факториал от X рекурсивным методом
fibonacci X                 - вычислить X-ое число Фибоначчи
fibo_recursive X       - вычислить X-ое число Фибоначчи рекурсивным методом

Дополнительно:
help        - показать текст с информацией о доступных командах
